  ...
  return (
    <div id="top">
      <TopSectionView
        ...
        description={(
          <>
            ООО «Ветеран» предоставляет комплексную помощь ветеранам<br/> и гражданам, пострадавшим в ходе специальной военной операции, включая социальную и юридическую поддержку, защиту прав, представление интересов, психологическую помощь и содействие профессиональной интеграции. Мы стремимся обеспечить их адаптацию, благополучие и полноценное участие<br/> в жизни общества.
          </>
        )}
