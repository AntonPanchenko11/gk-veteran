const CONCLUSION_TEXT =
  'Направление защиты интересов ООО «Ветеран. Защита интересов» стремится обеспечить ветеранам и пострадавшим гражданам всестороннюю поддержку, чтобы они могли восстановить свою жизнь, защитить свои права и почувствовать себя полноценной частью общества. Мы работаем для того, чтобы каждый подопечный получил уважение, справедливость и возможности для самореализации, внося вклад в укрепление социальной стабильности и справедливости.'
