const values = [
  <>Признание уникального опыта<br/> и достоинства каждого ветерана,<br/> как личности и специалиста</>,
  <>Забота о результатах работы<br/> и о благополучии всей команды</>,
  <>Постоянный поиск новых решений в вопросах адаптации и интеграции</>,
  <>Прозрачность и честность во всех процессах и решениях</>,
  <>Коллективное сотрудничество<br/> и поддержка друг друга</>,
