      ...
      <div className="mx-auto max-w-6xl px-6 py-8 lg:px-12 lg:py-12">
        ...
        <div className="mt-5 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {values.map((value) => (
            ...
            >
              <span className="mt-1 inline-flex h-7 w-7 items-center justify-center rounded-full border border-bronze/50 bg-bronze/15 text-xs font-semibold text-white">
                ✓
              </span>
