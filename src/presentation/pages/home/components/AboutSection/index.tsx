...
const PRINCIPLES: AboutSectionCard[] = [
  {
    ...
    description: (
      <>
        Нас возглавляют ветераны боевых действий и участники СВО — люди, закалённые во множестве конфликтов, преданные ценностям чести<br/> и ответственности. Один из главных жизненных приоритетов нашей команды — поддержка и содействие трудоустройству своих соратников, особенно тех, кто столкнулся<br/> с трудностями адаптации после полученных на службе травм или инвалидности.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Одно из приоритетных направлений деятельности компании — развитие медицинских информационных систем. Мы рассматриваем здравоохранение<br/> как важную сферу цифровизации, стремясь сделать медицинскую помощь максимально доступной, точной, быстрой и ориентированной на врача<br/> и пациента.
      </>
    ),
