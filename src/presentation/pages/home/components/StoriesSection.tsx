...
export function StoriesSection() {
  ...
  return (
    <section id="stories" className="bg-forest-950">
      <div className="mx-auto grid max-w-6xl gap-12 px-6 py-16 lg:grid-cols-[1.4fr_1fr] lg:px-12 lg:py-24">
        <div>
          <h2 className="text-3xl font-semibold text-white lg:text-4xl">Истории</h2>
          <p className="mt-6 text-sm leading-relaxed text-forest-100">
