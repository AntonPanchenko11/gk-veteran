...
function useStoryAccordion(stories: StoryEntity[]) {
  const initialTitle = stories[0]?.title ?? ''
  const [openedTitle, setOpenedTitle] = useState(initialTitle)
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 text-white">
        <p className="body-text text-white">
          Предлагаем вам ближе познакомится с командой группы компаний «ВЕТЕРАН». Наша миссия — это создание
          инновационных IT-решений, основанныхна богатом опыте и профессионализме команды. Мы — команда
