...
export function TopSection() {
  ...
  return (
    <div id="top">
      ...
      description="Предлагаем комплексные услуги в области системного инжиниринга: аудит IT-инфраструктуры, проектирование высоконагруженных систем, развертывание локальных вычислительных сетей (ЛВС) и работа с сетевым оборудованием. Мы обеспечиваем надежность, безопасность и масштабируемость решений, помогая бизнесу оптимизировать процессы."
